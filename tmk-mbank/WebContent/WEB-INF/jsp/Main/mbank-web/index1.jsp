                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><form action="/login"><button class="btn btn-success">Log In</button></form>
                            </li>
                        </ul>
                    </div>
                    <!-- /.navbar-collapse -->
                ...
                <ul>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div class="tp-caption mediumlarge_light_white sfl hidden-xs"
                            ...
                            SAFE | SECURE | ANYTIME | BANKING <br>
        ...
        <section id="about">
            <div class="container">
                ...
                <div class="section-heading scrollpoint sp-effect3">
                    ...
                    <p>
                        mBank is a cloud based mobile banking setup designed to enable mobility for co-operatives, microfinance, financial institutions and banks. The service integrates with the core banking software of each of these banks using a patented reverse tunnelling process.   The mobile banking and payments services offered through this setup include balance enquiry, P2P payments, interbank and intra bank transfers, mini statement, loan repayments, wallet service and bill payments.
                    </p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <div class="about-item scrollpoint sp-effect2">
                            ...
                            <h3>Easy setup</h3>
                            <p>Easy setup with financial institutions via built-in middleware, ISO 8583 or any other protocols</p>
                        </div>
                    </div>
                  <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                            ...
                            <h3>Lowest TCO</h3>
                            <p>Being a completely managed service mBank's SaaS provides you the lowest TCO (total cost of ownership) and the highest ROI on your IT investments.</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                            ...
                            <h3>Full Featured</h3>
                            <p>mBank SaaS platform comes with an exhaustive set of features and plug-ins that ensure your services are always ahead of the curve.</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect1">
                            ...
                            <h3>Secured</h3>
                            <p>Data and transaction security are at the core of our services. Compliant to the latest security guidelines we offer to you the most secure channel to reach out to your customers.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="review-filtering">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="assets/img/testimonial-bipul.jpg" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                                            <h3>“Absolutely knowledgeable company. Worked super fast and listened to needs carefully and delivered on time”</h3>
                                            <p>
                                                - Bipul Dhakal, Chairman &amp; Founder - D Soft &amp; IT Consultancy Pvt Ltd.
                                                <span>
                            ...
                            <div class="review rollitin">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="assets/img/testimonial-prakash.jpg" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                                            <h3>“mBank is the best team to work with.They develop relationship with their clients and we surely recommend their excellent team”</h3>
                                            <p>
                                                - Prakash Man Bajracharya CEO - Kankai Bikash Bank Ltd
                                                <span>
                                                    <i class="fa fa-star fa-lg"></i>
                                                    <i class="fa fa-star fa-lg"></i>
                                                    <i class="fa fa-star fa-lg"></i>
                            ...
                            <div class="review rollitin">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="assets/img/testimonial-sharad.jpg" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                                            <h3>“Great App! Great User Interface! I am using many banking app and on this mBank I have found new &amp; fantastic service on each updates.”</h3>
                                            <p>
                                                - Sarad Bhattarai, MD - Next Generation Enterprise Solutions Pvt. Ltd
                                                <span>
                                                    <i class="fa fa-star fa-lg"></i>
                                                    <i class="fa fa-star fa-lg"></i>
                                                    <i class="fa fa-star fa-lg"></i>
                            ...
                            <div class="review rollitin">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="assets/img/testimonial-sugrip.jpg" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                                            <h3>“The mBank team is amazing in the way they handled the project. They are very professional and understand the concept very well.”</h3>
                                            <p>
                                                - Sugrip Rana Magar - MD, Cloud Tech Pvt. Ltd.
                                                <span>
                                                    <i class="fa fa-star fa-lg"></i>
                                                    <i class="fa fa-star fa-lg"></i>
                                                    <i class="fa fa-star fa-lg"></i>
                            ...
                            <div class="review rollitin">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="assets/img/testimonial-hastinapur.jpg" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                                            <h3>“mBank Team is great to work with. Their experience and creativity helped us get the app we wanted, and their intuitive suggestions and improvements made it better than we could have envisioned on our own.”</h3>
                                            <p>
                                                - Hastinapur Multipurpose Cooperative Ltd.
                                                <span>
                                                    <i class="fa fa-star fa-lg"></i>
                                                    <i class="fa fa-star fa-lg"></i>
                                                    <i class="fa fa-star fa-lg"></i>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 contact-details scrollpoint sp-effect2">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">
                                            <a href="mailto:info@hamrotechnology.com.np">info@hamrotechnology.com.np</a>
                                        </h4>

                                        <h4 class="media-heading">
                                            <a href="mailto:hamrotechnologies@gmail.com">hamrotechnologies@gmail.com</a>
                                        </h4>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">+977-1-4469417</h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                               ...
                               <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d1766.3549209975113!2d85.33747113685963!3d27.69536153305764!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2snp!4v1499681727264" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        ...
        <footer>
            <div class="container">
                ...
                <div class="social">
                    ...
                    <a href="https://www.facebook.com/HTmBank/" target="_blank" class="scrollpoint sp-effect3"><i class="fa fa-facebook fa-lg"></i></a>
                </div>
                <div class="rights">
                    <p>&copy; Copyright 2017 Hamro Technology Pvt. Ltd. - mBank</p>

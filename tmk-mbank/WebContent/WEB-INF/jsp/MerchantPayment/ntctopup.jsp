						...
						<div class="col-lg-8 col-md-8 ">
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="col-lg-12">
										<ul>
											<li><a href="/payment/ntctopup/prepaid">PREPAID</a></li>
											<li><a href="/payment/ntctopup/postpaid">POSTPAID</a></li>
											<li><a href="/payment/ntctopup/cdmaprepaid">CDMA PREPAID</a></li>
											<li><a href="/payment/ntctopup/cdmapostpaid">CDMA POSTPAID</a></li>
										</ul>

...
<spr:page header1="Download Reports">
	<div class="col-md-12">
		<div class="break"></div>
				...
				<div class="rad-info-box">
					<div class="row">
						<form action="/customer/list" method="get" id="filterForm">
							...
							<div class="col-lg-2 col-md-2">
								<div class="form group">
									<label>Report Type</label> <select class="form-control selectpicker" name="reportType" data-live-search="true">
										<option value="" selected>Report Type</option>
										<c:forEach var="rts" items="${reportTypeList}">
											<c:choose>
												<c:when test="${rt eq rts.id}">
					...
					<%-- 		<c:choose>
							...
							<div class="col-lg-1 col-md-1">
								<div class="form group">
									<a onclick="postForm()"><i class="fa fa-download small" title="Search"></i></a>
								</div>
							</div>
						</form>
					</div>

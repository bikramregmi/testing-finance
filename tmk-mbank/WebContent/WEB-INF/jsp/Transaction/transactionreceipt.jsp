...
<%-- <spr:page header1="Payout Transaction">
	<div class="col-md-12">
		<div class="row col-md-4">
			<div class="break"></div>
			<form action="transaction/confirm" modelAttribute="transaction"
				method="post" class="col-md-112"
				style="float: none; margin-left: auto; margin-right: auto;">
				<!-- input type="hidden" value="${transaction.uniqueNumber}" /-->
			</form>
			<table class="table table-striped"
				...
				<tr>
					<td>Total Amount</td>
					<td>${transaction.totalSendingAmount}</td>
				</tr>
  ...
  <spr:page header1="Payout Transaction">
    ...
    <div class="container">
      ...
      <div class="row">
    	...
    	<form action="${pageContext.request.contextPath}/transaction/receipt" method="post">
    	<div class="form-group">
			<button class="btn btn-primary btn-md btn-block btncu">
				Done
			</button>

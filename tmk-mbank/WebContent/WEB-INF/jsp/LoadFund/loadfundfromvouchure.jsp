				...
				<div class="col-lg-12">
					<div class="row">
						...
						<div class="col-lg-8 col-md-8 ">
							<div class="row">
								<div class="col-lg-12">
									<h2>LOAD MONEY FROM VOUCHURE</h2>
									<div class="col-lg-12">
										<h4>{{vouchureloadMessage}}</h4>
										<div class="form-group">
											<label class="col-md-4 control-label">Vouchure Number </label>
											<div class="col-md-4 inputGroupContainer">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="glyphicon glyphicon-user"></i></span> <input
														name="" ng-model="vouchureId"
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<button type="submit" ng-click="loadFundFromVouchure()"

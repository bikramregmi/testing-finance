...
<spr:page header1="Load Fund">
	<div class="row pull-right" ng-controller="reportController">
		...
		<div class="col-md-2">
			<div class="dropdown pull-right">
				...
				<ul class="dropdown-menu">
					<li style="text-align: center; color: grey;">Load Fund</li>
		...
		<%@include file="/WEB-INF/jsp/reports/loadFundReport.jsp"%>
	</div>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<h5>You are about to load {{balance}} balance .</h5>
			</div>
			<div class="modal-footer">
			
                 <button type="button" class="btn btn-primary" ng-click="loadFund()">Ok</button>

...
<script src="../js/wallet/angular.min.js"></script>
<script src="../js/wallet/controller.js"></script>
<script>
	function myFunction() {
...
<body ng-app="mywallet" ng-controller="mycontroller">
	<div class="container">
									...
									<div class="col-lg-12">
										<form class="well form-horizontal">
											...
											<div class="form-group">
												<label class="col-md-4 control-label">Financial Inc
													Name </label>
												<div class="col-md-4 inputGroupContainer">
													<div class="input-group">
														<span class="input-group-addon"><i
															class="glyphicon glyphicon-user"></i></span> <input
															name="destinationEmail" ng-model="financialIncId"
											...
											<div class="form-group">
												...
												<div class="col-md-4 inputGroupContainer">
													<div class="input-group">
														<span class="input-group-addon"><i
															class="glyphicon glyphicon-user"></i></span> <input
															name="amount" ng-model="finamount" class="form-control"
															type="text">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<button type="submit" ng-click="withdrawFund()"
														class="btn btn-warning">
														Withdraw Money <span class="glyphicon glyphicon-send"></span>
													</button>
												</div>
											</div>
										</form>

		...
		<table id="transaction" class="table table-striped">
			...
			<tbody>
						<tr>
							...
							<td><a
								href="${pageContext.request.contextPath}/online/transaction/payout/view?transactionId=${transaction.id}"
								class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
									View Details </a></td>
							<td><a
								href="${pageContext.request.contextPath}/online/editTransaction?transactionId=${transaction.id}"
								class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
									Edit </a></td>
							<td><a
								href="${pageContext.request.contextPath}/online/deleteTransaction?transactionId=${transaction.uniqueNumber}"

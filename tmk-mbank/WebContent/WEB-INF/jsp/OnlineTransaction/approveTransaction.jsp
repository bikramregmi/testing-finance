...
<spr:page header1="Approve Transaction">
	<div class="col-md-12">
		<div class="row col-md-4">
			<div class="break"></div>
			<form action="approveTransaction" modelAttribute="transaction"
				...
				<div class="form-group">
					...
					<label>Destination Country</label> <input type="text" name="payoutCountry"
						class="form-control input-sm" readonly value="${transaction.payoutCountry.name}" readonly>
				...
				<div class="form-group">
					<label>Sender</label> <input type="text" name="sender"
						class="form-control input-sm" readonly value="${transaction.sender.firstName}">
					<p class="error">${error.sender}</p>
				</div>
				
				<div class="form-group">
					<label>Beneficiary</label> <input type="text" name="beneficiary"
						class="form-control input-sm" readonly value="${transaction.beneficiary.firstName}">
				...
				<div class="form-group">
					<label>Remit Agent</label> <input type="text" name="remitAgent"
						class="form-control input-sm" readonly value="${transaction.remitAgent.firstName}">
					<p class="error">${error.remitAgent}</p>
				</div>
				<div class="form-group">
					<label>Payout Agent</label> <input type="text" name="payoutAgent"
						class="form-control input-sm" readonly value="${transaction.payoutAgent.firstName}">
				...
				<div class="form-group">
					<label>Change Status to:</label> <select name="transactionStatus"
						id="transactionStatus" class="form-control input-sm"
						required="required" >
						<option value="CancelledWithRefund">Cancelled With Refund</option>
						<option value="CancelledWithoutRefund">Cancelled Without Refund</option>

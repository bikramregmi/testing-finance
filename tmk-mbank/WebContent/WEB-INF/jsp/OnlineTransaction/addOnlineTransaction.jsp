...
<spr:page header1="Add Transaction">
	<div class="col-md-12">
		<div class="row col-md-4">
			<div class="break"></div>
			<form action="${pageContext.request.contextPath}/online/addTransaction" modelAttribute="transaction"
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/resources/js/onlinetransaction.js"></script>

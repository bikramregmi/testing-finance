...
<spr:page header1="Add Account">
	<div class="col-md-12">
		<div class="row col-md-4">
			<div class="break"></div>
			<form action="${pageContext.request.contextPath}/bank/editprofileaccounts" method="post" class="col-md-12" style="float: none; margin-left: auto; margin-right: auto;">
				<input type="hidden" name="id" value="${accounts.id}">
				<div class="form-group">
					<label>Registration Pool Account Number</label>
					<input type="text" name="registrationAccount" required class="form-control input-sm" value="${accounts.registrationAccount}"> 
				</div>
				<div class="form-group">

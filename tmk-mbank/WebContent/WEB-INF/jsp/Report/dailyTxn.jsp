...
<spr:page header1="Daily Transaction Report">
		<div class="break"></div>
		<form  action="dailyTxnReport" modelAttribute="menu" method="post" class="col-md-offset-4 col-md-4" style="float: none; margin-left: auto; margin-right: auto;">

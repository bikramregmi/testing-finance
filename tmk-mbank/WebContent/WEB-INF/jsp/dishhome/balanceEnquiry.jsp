			...
			<div class="col-lg-8 col-md-8 ">
				<div class="row">
					<div class="col-lg-12">
						...
						<input type="hidden" ng-init="balanceurl='balanceenquiry'"  ng-model="balanceenquiry" >
					...
					<button ng-click="balanceEnquiry(balanceurl)" class="btn btn-primary btn-md btn-block btncu">Check Balance</button>
				</div>
				</div>
			</div>
		</div>

			...
			<div class="col-lg-8 col-md-8 ">
				<div class="row">
					<div class="col-lg-12">
						...
						<input type="hidden" ng-init="generalpaymenturl='ePayOnlinePayment'"  ng-model="ePayOnlinePayment" >
					...
					<div class="form-group">
					<button ng-click="onlinePaymentEpay(generalpaymenturl)" class="btn btn-primary btn-md btn-block ">Submit</button>
				</div>
				</div>
			</div>
		</div>

...
<spr:page header1="Add Compliance">
	<div class="col-md-12">
		<div class="row col-md-4">
			<div class="break"></div>
			<form action="addCompliance" modelAttribute="compliance" method="post"
				class="col-md-12"
				...
				<div class="form-group">
					...
					<select name="country"
						...
						<c:forEach var="country" items="${countryList}">
								<c:choose>
									<c:when
										test="${country.name == compliance.country}">
				...
				<div class="form-group">
					<label>Requirements</label> <textarea name="requirements"
						class="form-control input-sm" required="required"
						value="${compliance.requirements}"></textarea>
					<p class="error">${error.requirements}</p>
				</div>
				<div class="form-group">
				<label>Compliance Type</label>
				<select name="complianceType" id="complianceType"
						class="form-control input-sm" >
				<option value="Sending" >Sending</option>
				<option value="Receiving" >Receiving</option>
				</select>
				<p class="error">${error.complianceType}</p>
				</div>
				<div class="form-group">

...
<spr:page header1="Edit Aml">
	<div class="col-md-12">
		<div class="row col-md-4">
			<div class="break"></div>
			<form action="editAml" modelAttribute="aml" method="post"
				class="col-md-12"
				style="float: none; margin-left: auto; margin-right: auto;">
				<div class="form-group">
					<label>Source</label><input type="hidden" name="id"
						value="${aml.id}"> <input type="text" name="source"
